...
public class AccountHolder implements Serializable{
	...
	public AccountHolder(String username, String password, String firstname, String lastname, boolean isLoggedIn) {
		super();
	...
	public String toString() {
		return "AccountHolder [id=" + id + ", username=" + username + ", password=" + password + ", firstname="
